...
- (VMKBindingDictionary *)viewModelBindings {
    ...
    if ([self.viewModel respondsToSelector:@selector(image)]) {
        [bindings addEntriesFromDictionary:@{ VMK_BINDING_PROPERTY(image) }];
    }
